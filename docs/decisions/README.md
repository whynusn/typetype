...
| 013 | [收敛到三仓模型并移除 typetype-server 耦合](./013-converge-to-three-repo-model.md) | 2026-08-13 | proposed |
| 014 | [OTA 更新检查与镜像加速下载（GitHub Releases）](./014-ota-update-check-and-mirror-download.md) | 2026-08-13 | proposed |
